    ...
    return (
        <div className={styles.card}>
            <div className={styles.top}>
                {noUi ? null : <div className={styles.like} onClick={() => handlerFavorite(id, title, price, image, parentId, active)}>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.info}>
                    ...
                    {noUi ? null : <button className={styles.btn} onClick={() => handlerCart(id, title, price, image, parentId)}>
